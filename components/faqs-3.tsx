...
export default function FAQsThree() {
    const faqItems: FAQItem[] = [
        ...
        },
        {
            ...
            answer: 'Once your order ships, you&apos;ll receive a confirmation email with a tracking number. You can use this number on our website or the carrier&apos;s website to track your package. You can also view order status and tracking information in your account dashboard under "Order History".', // Changed here
        },
    ]
                    ...
                    <div className="md:w-1/3">
                        <div className="sticky top-20">
                            ...
                            <p className="text-muted-foreground mt-4">
                                Can&apos;t find what you&apos;re looking for? Contact our{' '} {/* Changed here as well */}
                                <Link
                                    href="#"
